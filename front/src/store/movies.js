...
export const getIdMovie = createAsyncThunk("GET_MOVIE", (input) => {
    return axios.get(`https://api.themoviedb.org/3/movie/${input}?api_key=${apiKey}&language=en-EN`)
        .then((r) => r.data);
});
...
const moviesReducer = createReducer([], {
    ...
    [getIdMovie.fulfilled]: (state, action) => action.payload
})
